...
router.post('/produtos', upload.single('foto_local'), csrfValidateAfterUpload, adminController.salvarNovoProduto);
router.put('/produtos/:id', upload.single('foto_local'), csrfValidateAfterUpload, adminController.salvarEdicaoProduto);
